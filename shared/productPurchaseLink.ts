...
export const DEFAULT_QUOTATION_ROUTING_TEMPLATES: QuotationRoutingTemplates = {
  ...
  samePageResponse: 'اگر مایل باشید می‌توانید فرم استعلام آنلاین همین صفحه را تکمیل کنید و قیمت بگیرید. اگر ترجیح می‌دهید، من همینجا چند سؤال کوتاه می‌پرسم و درخواستون برای کارشناس میفرستم.',
  differentPageResponse: 'اگر مایل باشید می‌توانید فرم استعلام آنلاین را تکمیل کنید و قیمت بگیرید:\n{{purchaseUrl}}\nاگر ترجیح می‌دهید، من همینجا چند سؤال کوتاه می‌پرسم و درخواستون برای کارشناس میفرستم.',
