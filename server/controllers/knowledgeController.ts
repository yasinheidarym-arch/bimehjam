  ...
  if (productsCount === 0) {
    ...
    const managerProduct = await prisma.insuranceProduct.create({
      data: {
        ...
        benefits: 'تخفیف و شرایط پرداخت مطابق نتیجهٔ استعلام و شرایط تأییدشدهٔ محصول',
    ...
    const carProduct = await prisma.insuranceProduct.create({
      data: {
        ...
        benefits: 'تخفیف نقد و شرایط اقساط مطابق نتیجهٔ استعلام',
    ...
    await prisma.responseTemplate.createMany({
      data: [
        ...
        },
        {
          ...
          content: 'لطفاً تصویر واضح از کارت خودرو (پشت و رو) و بیمه‌نامه سال قبل را در همین چت ارسال فرمایید تا درخواست پس از تأیید شما بررسی شود.',
